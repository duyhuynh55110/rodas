            ...
            <div class="col-sm-12">
                <div class="card card-primary">
                    <form id="productForm" class="form-horizontal" method="POST"
                        data-upload-to-storage="{{ routeAdmin('upload-to-storage') }}"
                        action="{{ routeAdmin('products.save') }}"
                        ...
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input required maxlength="100" name="name" autocomplete="off" class="form-control"
                                        id="inputName" placeholder="Enter name" value="{{ $inputName }}">
                                </div>
                            </div>
                            <!-- .name -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input required min="0" max="{{ MAX_INTEGER_VALUE }}" type="number"
                                        name="item_price" autocomplete="off" class="form-control" id="inputItemPrice"
                                        placeholder="Enter price" value="{{ $inputItemPrice }}">
                                </div>
                            </div>
                            <!-- .item-price -->
                                    ...
                                    <select required name="brand_id" class="custom-select select2" id="selectBrand">
                                        ...
                                        @foreach ($brands as $brand)
                                            <option value="{{ $brand->id }}"
                                                {{ $brand->id == $selectBrandId ? 'selected' : '' }}>{{ $brand->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select required name="category_ids[]" multiple="multiple"
                                        data-placeholder="Select categories" class="custom-select select2"
                                        id="selectCategories">
                                ...
                                <div class="col-sm-10">
                                    <div class="custom-file">
                                        <input id="uploadImage" name="image_file_upload" type="file"
                                            class="custom-file-input" filesize="{{ UPLOAD_MAX_SIZE }}"
                                            accept="image/jpeg, image/png" {{ $requiredInputImage }}>
                            ...
                            @if ($isUpdateForm)
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        <img width="120" src="{{ $srcImage }}" alt="{{ $srcImage }}"
                                            class="rounded">
                                    </div>
                                </div>
                                <!--.review-image -->
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label" for="uploadImage"> Image Slides </label>
                                <div class="col-sm-10">
                                    <div class="dropzone image-slides"></div>
                                </div>
                            </div>
                            ...
                            @if ($isUpdateForm)
                                <div class="form-group row">
                                    <label class="col-sm-2 col-form-label">&nbsp;</label>
                                    <div id="reviewImageSlides" class="col-sm-10" data-json='@json($product->productSlides)'></div>
                                </div>
                                <!--.review-image-slides -->
                            @endif
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea maxlength="5000" name="description" id="txtDescription" cols="30" rows="10" class="form-control"
                                        placeholder="Enter description">{{ $txtDescription }}</textarea>
                                </div>
                            </div>
                            <!-- .description -->
                        </div>
